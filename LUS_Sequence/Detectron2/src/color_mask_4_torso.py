...
cv2.imwrite('LUS_Sequence/Detectron2/results/frame.png', frame)
cv2.imwrite('LUS_Sequence/Detectron2/results/hsv.png', hsv)
cv2.imwrite('LUS_Sequence/Detectron2/results/mask.png', mask)
cv2.imwrite('LUS_Sequence/Detectron2/results/res.png', res)